...
def get_steam_data(payload: dict):
    try:
        STEAM_API_KEY = os.getenv("STEAM_API_KEY") or "<YOUR_STEAM_API_KEY>"
        steam_id = payload.get("steamId")
        if not STEAM_API_KEY or not steam_id:
            return {"error": "STEAM_API_KEY or steamId missing"}
        ...
        print("GetPlayerSummaries:", profile_data)
        ...
        logging.exception("Error in /steam endpoint")
        return {"error": str(e)}
